  ...
  metrics.update(
      {
          "auc-roc": 100*sklearn.metrics.roc_auc_score(
              targets, probs, multi_class="ovr"),
          "auc-pr": 100*sklearn.metrics.average_precision_score(targets, probs),
          "accuary": 100*sklearn.metrics.accuracy_score(targets, predictions),
      })
  return metrics
